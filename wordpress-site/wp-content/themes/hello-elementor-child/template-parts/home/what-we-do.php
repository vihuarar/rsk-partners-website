...
$what_products = array(
	...
	array(
		'type'    => 'image',
		'src'     => 'external-facade-second-image-what-we-do.jpg',
		'caption' => 'Duplexes',
	),
	array(
		'type'    => 'image',
...
?>
<section class="rsk-reveal-root tw-bg-[#ebe8e3] tw-py-[clamp(3rem,7vw,6rem)] tw-relative tw-left-1/2 tw-right-1/2 -tw-mx-[50vw] tw-w-screen tw-overflow-x-hidden" data-rsk-reveal>
	<div class="tw-max-w-rsk tw-mx-auto tw-px-[clamp(1rem,3vw,2rem)]">
		<div class="tw-grid tw-grid-cols-1 lg:tw-grid-cols-[minmax(0,1fr)_3fr] tw-gap-x-0 tw-gap-y-[clamp(2rem,4vw,3rem)] tw-items-start">
			...
			<h2 class="rsk-reveal rsk-reveal--rise tw-font-serif tw-text-[clamp(3rem,7.5vw,6rem)] tw-leading-[0.95] tw-text-[#1f4e8c] tw-font-normal tw-m-0 tw-tracking-tight tw-relative tw-z-0">
			...
			<div class="tw-relative tw-z-10 tw-grid tw-grid-cols-1 sm:tw-grid-cols-[2fr_3fr] tw-gap-x-8 tw-gap-y-4 lg:tw-pl-6 tw-items-start">
				<p class="rsk-reveal rsk-reveal--fade tw-m-0 tw-text-rsk-ink tw-font-sans tw-text-[0.95rem] tw-leading-relaxed" style="--rsk-reveal-delay:120ms">
				...
				<div class="tw-flex tw-flex-col tw-gap-4 tw-text-rsk-ink tw-font-sans tw-text-[0.95rem] tw-leading-relaxed">
					<p class="rsk-reveal rsk-reveal--fade tw-m-0" style="--rsk-reveal-delay:200ms"><?php echo $what_paragraphs[1]; ?></p>
					<p class="rsk-reveal rsk-reveal--fade tw-m-0" style="--rsk-reveal-delay:280ms"><?php echo $what_paragraphs[2]; ?></p>
				</div>
			</div>

			<div class="rsk-reveal rsk-reveal--slide-left tw-relative tw-w-full tw-bg-black tw-text-white tw-flex tw-items-center lg:tw-self-center tw-px-[clamp(1.25rem,2.5vw,2rem)] tw-py-[clamp(1.25rem,2vw,1.75rem)] lg:before:tw-content-[''] lg:before:tw-absolute lg:before:tw-inset-y-0 lg:before:tw-right-full lg:before:tw-w-screen lg:before:tw-bg-black" style="--rsk-reveal-delay:100ms">
			...
			<div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-3 tw-gap-x-3 tw-gap-y-6">
				<?php foreach ( $what_products as $i => $p ) : ?>
					<figure class="rsk-reveal rsk-reveal--rise-image tw-m-0" style="--rsk-reveal-delay:<?php echo esc_attr( 150 + $i * 140 ); ?>ms">
						<div class="rsk-parallax__frame">
							<?php if ( 'video' === $p['type'] ) : ?>
								<video
						...
						<figcaption class="tw-pt-3 tw-text-left tw-text-base !tw-not-italic !tw-font-normal tw-text-rsk-ink-soft tw-font-sans">
