...
= WP Engine Site Migration 1.8.1 - 2026-05-18 =
* New: Tooltips with additional documentation can now be accessed through a linked Icon
* New: Toast notifications show success or failure of connection key resets
* Fixed: The Save Profile button is now disabled once a user clicks Start Migration in order to prevent false save operations

= WP Engine Site Migration 1.8.0 - 2026-04-22 =
* New: Updated user interface based on the WP Engine Plugin Design System
