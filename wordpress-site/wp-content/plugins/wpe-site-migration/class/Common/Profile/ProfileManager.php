...
class ProfileManager {
	 ...
	 * @param ProfileImporter    $profile_importer
	 */
	...
	public function add_profile() {
		...
		if ( ! is_array( $existing_profiles ) || empty( $existing_profiles ) ) {
			// Ensure 1st profile has ID of 1 by starting array index at 1.
	...
	/**
	 * REST-API handler for removing a profile.
	 *
	 * @throws Exception
	 */
	...
	/**
	 * REST-API handler for renaming a profile.
	 *
	 * @throws Exception
	 */
	...
	/**
	 * REST-API handler for overwriting a profile.
	 *
	 * @throws Exception
	 */
